...
class PermissionClassifyController extends Controller{
    ...
    public function index(Request $request){
        ...
        return view('admin.permissionClass.index',['actionsClassify'=>$actionsClassify]);
    }

    public function add(Request $request){
        return view('admin.permissionClass.add');
    }
    ...
    public function edit(Request $request){
        ...
        return view('admin.permissionClass.edit',['actionClassify'=>$actionClassify]);
    }
