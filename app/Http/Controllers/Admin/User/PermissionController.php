...
class PermissionController extends Controller{
    ...
    public function index(Request $request){
        $actions = Action::get();
        return view('admin.permission.index',['actions'=>$actions]);
    }

    public function add(Request $request){
        $actionClassify = ActionClassify::get();
        return view('admin.permission.add',['actionClassify'=>$actionClassify]);
    }
    ...
    public function edit(Request $request){
        ...
        $actionClassify = ActionClassify::get();
        return view('admin.permission.edit',['action'=>$action,'actionClassify'=>$actionClassify]);
    }
