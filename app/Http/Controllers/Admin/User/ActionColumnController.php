...
class ActionColumnController extends Controller{
    ...
    public function index(Request $request){
        ...
        return view('admin.actionColumn.index',['actionColumn'=>$actionColumn]);
    }
    ...
    public function add(Request $request){
        ...
        $groups = Group::get();
        return view('admin.actionColumn.add',['actionColumn'=>$actionColumn,'actionClassify'=>$actionClassify,'groups'=>$groups]);
    }
    ...
    public function edit(Request $request){
        ...
        $actionClassify = ActionClassify::get();
        $groups = Group::get();
        return view('admin.actionColumn.edit',['actionColumn'=>$actionColumn,'actionClassify'=>$actionClassify,'groups'=>$groups]);
    }
