                ...
                <div class="col-md-12">
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <a href="/about/create"><button class="btn btn-success btn-xs pull-right">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-condensed table-hover">
                            ...
                            @foreach($abouts as $about)
                                <tr>
                                    <td>{{$about->name}}</td>
                                            <td>{{App\Constants\ArticleStatus::trans($about->status)}}</td>
                                    <td><a onclick="del(this);" href="javascript:void(0);" data-id="{{$about->id}}">删除</a>／<a href="/about/edit?id={{$about->id}}">修改</a>／<a href="{{env('WEB_URL')}}/about" target="_blank">预览</a></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
