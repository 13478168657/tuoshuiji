            ...
            <div class="row">
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <form class="form-inline" id="articleSubmit"  method="post" enctype="multipart/form-data" action="/manage/postEdit">
                            {{csrf_field()}}
                            ...
                            <table class="table table-condensed table-add">
                                <tr>
                                    <th style="width:10%;">
                                        <label for="case_foreman_id">title:</label>
                                    </th>
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="title" value="{{$article->title}}" class="form-control" style="width:350px;" id="inputPassword2" placeholder="title">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="width:10%;">
                                        <label for="case_foreman_id">author:</label>
                                    </th>
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="author" class="form-control" id="inputPassword2" value="{{$article->author}}" style="width:350px;" placeholder="author">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="width:10%;">
                                        <label for="case_foreman_id">from:</label>
                                    </th>
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" name="source" value="{{$article->source}}" class="form-control" style="width:350px;" id="inputPassword2" placeholder="from">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th style="width:10%;">
                                        <label for="case_foreman_id">titlePic:</label>
                                    </th>
                                ...
                                <tr>
                                    <th style="width:10%;">
                                        <label for="case_foreman_id">metaKeyWord:</label>
                                    </th>
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <input type="text" class="form-control" id="inputPassword2" name="meta_keyword" style="width:350px;" value="{{$article->meta_keyword}}"  size="70" maxlength="250" placeholder="metaKeyWord">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                 <textarea type="text" size="90" style="width:350px;height:80px;" maxlength="350" class="form-control description" id="inputPassword2"  name="meta_description" placeholder="description">{{$article->meta_description}}</textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                        <label for="case_title">state:</label>
                                    </th>
                                    <td>
                                        <div class="form-group">
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="inlineRadio1" {{$article->status==1?"checked":''}} value="1"> nopass
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="inlineRadio2" {{$article->status==2?"checked":''}} value="2"> waitpass
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" id="inlineRadio3" {{$article->status==3?"checked":''}} value="3"> pass
                                            </label>
                                        </div>
                                    </td>
                                </tr>
