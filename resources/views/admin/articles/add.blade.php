        ...
        <div class="wrapper table-scroll-wrapper">
            <div class="row">
                <div class='col-md-12'>
                    <div class="table-responsive">
                        <form class="form-inline" method="post" enctype="multipart/form-data" id="articleSubmit" action="/manage/postCreate">
                            {{csrf_field()}}
            ...
            <input type="hidden" name="image" value=""/>
                                ...
                                <tr>
                                    ...
                                    <td style="width:90%;">
                                        <div class="form-group">                                                                <textarea type="text" size="90" style="width:350px;height:80px;" maxlength="350" class="form-control description" id="inputPassword2"  name="meta_description" placeholder="meta描述"></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
